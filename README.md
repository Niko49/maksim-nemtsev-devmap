...
### Типы данных
**Цель** - познакомиться с основными типами данных.
...
### HTML & CSS
**Цель** - познакомиться с такими понятиями как:
- [ ] Верстка
- [ ] HTML 5
- [ ] Разметка
- [ ] Семантика
...
Для этого необходимо познакомиться с такими понятиями как:
- [ ] User-agent
- [ ] DNS
...
### Тестирование
**Цель** - познакомиться с различными видами тестов, такими как:
...
### Безопасность сайтов
**Цель** - познакомиться с различными видами уязвимостей:
- [ ] SQL-инъекция
